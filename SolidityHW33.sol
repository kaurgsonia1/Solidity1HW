...
// lvl 3: equity plan //Distributing Shares over time... 
contract DeferredEquityPlan {
    ...
    function distribute() public {
        ...
        require(unlock_time <= now, "ERROR, shares not vested.");
        // 2: `distributed_shares` is less than the `total_shares`
        // Your code here!
        require(distributed_shares < total_shares, "ERROR, please try again." );
